package com.clow.mallclow.demo.controller;

import com.clow.mallclow.common.api.CommonPage;
...
public class DemoController {
    ...
    @RequestMapping(value = "brand/listAll",method = RequestMethod.GET)//请求映射地址
    @ResponseBody//告知Spring框架，方法返回的字符串不是跳转是直接在http响应体中返回
